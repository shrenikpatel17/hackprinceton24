...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const systemPrompt = "You are a helpful financial assistant. You must CONCISELY answer questions to explain the cause of certain market anomalies. Be as accurate and educational as possible.";
